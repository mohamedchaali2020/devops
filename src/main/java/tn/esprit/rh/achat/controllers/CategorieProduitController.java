...
public class CategorieProduitController {
	...
	@ResponseBody
	public CategorieProduit addCategorieProduit(@RequestBody CategorieProduit ccp) {
		CategorieProduit categorieProduit = categorieProduitService.addCategorieProduit(ccp);
	...
	@ResponseBody
	public CategorieProduit modifyCategorieProduit(@RequestBody CategorieProduit ccp) {
		return categorieProduitService.updateCategorieProduit(ccp);
	}
